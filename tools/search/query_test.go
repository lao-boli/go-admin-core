...
type ApplicationQuery struct {
	...
	TestJoin  `search:"type:left;on:id:receipt_id;table:receipt_goods;join:receipts;alias:t1"`
	TestJoin2 `search:"type:left;on:id:receipt_id;table:receipt_goods;join:receipts;alias:t2"`
...
func TestResolveSearchQuery(t *testing.T) {
	d := ApplicationQuery{
		...
		TestJoin2:        TestJoin2{PaymentAccount: "1213"},
	}
